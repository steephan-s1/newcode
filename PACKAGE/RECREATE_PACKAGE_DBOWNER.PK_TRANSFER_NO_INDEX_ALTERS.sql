CREATE PACKAGE DBOWNER.PK_TRANSFER_NO_INDEX_ALTERS
  CREATE OR REPLACE EDITIONABLE PACKAGE "DBOWNER"."PK_TRANSFER_NO_INDEX_ALTERS" AS
...
END pk_transfer_no_index_alters;
 
/
CREATE OR REPLACE EDITIONABLE PACKAGE BODY "DBOWNER"."PK_TRANSFER_NO_INDEX_ALTERS" AS
