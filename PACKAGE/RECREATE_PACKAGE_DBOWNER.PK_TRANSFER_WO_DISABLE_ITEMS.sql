CREATE PACKAGE DBOWNER.PK_TRANSFER_WO_DISABLE_ITEMS
  CREATE OR REPLACE EDITIONABLE PACKAGE "DBOWNER"."PK_TRANSFER_WO_DISABLE_ITEMS" AS
...
END pk_transfer_wo_disable_items;
 
/
CREATE OR REPLACE EDITIONABLE PACKAGE BODY "DBOWNER"."PK_TRANSFER_WO_DISABLE_ITEMS" AS
