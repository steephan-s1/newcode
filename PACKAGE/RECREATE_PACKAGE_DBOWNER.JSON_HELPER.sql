CREATE PACKAGE DBOWNER.JSON_HELPER
  CREATE OR REPLACE EDITIONABLE PACKAGE "DBOWNER"."JSON_HELPER" as
  /* Example:
  set serveroutput on;
  declare
    v_a json;
...
/
CREATE OR REPLACE EDITIONABLE PACKAGE BODY "DBOWNER"."JSON_HELPER" as
